class Produto:
    ...
    def visualizar_quantidade_em_estoque(self) -> None:
        print(f"A quantidade em estoque do produto {self:descricao} eh {self.quantidade_estoque}.")

if __name__ == "__main__":
    print("Executando no modelo orientado a objetos...")

    produto1 = Produto(1, 'Notebook', 3500.0)
    produto1.vizualizar_quantidade_em_estoque()